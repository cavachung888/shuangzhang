...
Route::middleware(['admin_auth:admin'])
    ->group(function () {
        ...
        Route::resource('/copper_prices', Controllers\CopperPriceController::class);
        ...
        Route::put('/contacts/{contact}', [Controllers\ContactController::class, 'update'])->name('contacts.update');
