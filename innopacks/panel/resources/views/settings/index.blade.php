          ...
          <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="tab-setting-basics">
              <div class="row g-3">
                ...
                <div class="col-md-3">
                  <x-panel-form-image title="首页产品图1（异形铜卷）" name="product_image_1" value="{{ old('product_image_1', system_setting('product_image_1')) }}"/>
                </div>
                <div class="col-md-3">
                  <x-panel-form-image title="首页产品图2（定制铜排）" name="product_image_2" value="{{ old('product_image_2', system_setting('product_image_2')) }}"/>
                </div>
              </div>
              <div class="mb-3"></div>
